...
# Stampede system.
#----------------------------------------------------
#SBATCH -J symmetric_job_inter_smp_320_E5MIC    # Job name
#SBATCH -o symmetric_job_inter_smp_320_E5MIC_%j.log # Name of stdout output file(%j expands to jobId)
#SBATCH -e error_symmetric_job_inter_smp_320_E5MIC.o%j # Name of stderr output file(%j expands to jobId)
...
TOTAL=20
TITLE="INTER SMP 320 ranks (E5/MIC) - 16 nodes (256 mic 64 e5) (16/mic && 4/e5)"
H_BIN="\"com.cpu -o 50\""
...
export MIC_OMP_NUM_THREADS=320
...
# will use 320_E5MIC threads/task.

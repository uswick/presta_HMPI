...
# Stampede system.
#----------------------------------------------------
#SBATCH -J symmetric_job_inter_smp_1000_E5MIC    # Job name
#SBATCH -o symmetric_job_inter_smp_1000_E5MIC_%j.log # Name of stdout output file(%j expands to jobId)
#SBATCH -e error_symmetric_job_inter_smp_1000_E5MIC.o%j # Name of stderr output file(%j expands to jobId)
#SBATCH -p normal-mic #development       # Submit to the 'normal' or 'development' queue
#SBATCH -N 50              # Total number of nodes requested (16 cores/node)
...
TOTAL=20
TITLE="INTER SMP 1000 ranks (E5/MIC) - 50 nodes (800 mic 200  e5) (16/mic && 4/e5)"
H_BIN="\"com.cpu -o 50\""

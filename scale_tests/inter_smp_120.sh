...
# Stampede system.
#----------------------------------------------------
#SBATCH -J symmetric_job_inter_smp_120    # Job name
#SBATCH -o symmetric_job_inter_smp_120_%j.log # Name of stdout output file(%j expands to jobId)
#SBATCH -e error_symmetric_job_inter_smp_120.o%j # Name of stderr output file(%j expands to jobId)
...
#SBATCH -t 01:20:00          # Run time (hh:mm:ss) - 1.5 hours
...
TOTAL=20
TITLE="INTER SMP 120 ranks (MIC) - 2 nodes"
H_BIN="\"a.out  uswick\""

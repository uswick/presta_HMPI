...
# Stampede system.
#----------------------------------------------------
#SBATCH -J symmetric_job_inter_smp_480_E5MIC    # Job name
#SBATCH -o symmetric_job_inter_smp_480_E5MIC_%j.log # Name of stdout output file(%j expands to jobId)
#SBATCH -e error_symmetric_job_inter_smp_480_E5MIC.o%j # Name of stderr output file(%j expands to jobId)
...
TOTAL=20
TITLE="INTER SMP 480 ranks (E5/MIC) - 24 nodes (384 mic 96 e5) (16/mic && 4/e5)"
H_BIN="\"com.cpu -o 50\""

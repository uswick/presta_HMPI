...
# Stampede system.
#----------------------------------------------------
#SBATCH -J symmetric_job_inter_smp_480    # Job name
#SBATCH -o symmetric_job_inter_smp_480_%j.log # Name of stdout output file(%j expands to jobId)
#SBATCH -e error_symmetric_job_inter_smp_480.o%j # Name of stderr output file(%j expands to jobId)
...
TOTAL=20
TITLE="INTER SMP 480 ranks (MIC) - 8 nodes"
H_BIN="\"a.out  uswick\""

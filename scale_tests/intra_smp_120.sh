...
# Stampede system.
#----------------------------------------------------
#SBATCH -J symmetric_job_intra_smp_120    # Job name
#SBATCH -o symmetric_job_intra_smp_120_%j.log # Name of stdout output file(%j expands to jobId)
#SBATCH -e error_symmetric_job_intra_smp_120.o%j # Name of stderr output file(%j expands to jobId)
...
TOTAL=20
TITLE="INTRA SMP 120 ranks (MIC) - 1 node"
H_BIN="\"a.out  uswick\""

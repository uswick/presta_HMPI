...
# Stampede system.
#----------------------------------------------------
#SBATCH -J symmetric_job_intra_smp_60    # Job name
#SBATCH -o symmetric_job_intra_smp_60_%j.log # Name of stdout output file(%j expands to jobId)
#SBATCH -e error_symmetric_job_intra_smp_60.o%j # Name of stderr output file(%j expands to jobId)
...
#SBATCH -A TG-CCR140001  # Allocation name to charge job against
##SBATCH -A RangerTechInsertion   # Allocation name to charge job against
...
TOTAL=10
TITLE="INTRA SMP 60 ranks (MIC) - 1 node with com_u"
H_BIN="\"a.out  uswick\""
MIC_BIN="\"com_up.mic -o 50\""

...
#SBATCH -p development #normal-mic        # Submit to the 'normal' or 'development' queue
...
#export KMP_PLACE_THREADS=15c,2t
export MIC_KMP_AFFINITY=verbose,norespect,scatter
#export MIC_KMP_AFFINITY=verbose,scatter
...
#ibrun.symm  -m "./stream_c2.exe"
ibrun.symm  -m "./com_uo.mic"
